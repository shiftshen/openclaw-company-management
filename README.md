...
- **Portable Workspace Defaults**
  Defaults to `/Users/shift/openclaw/workspace-xmanx` on the primary local machine and `${HOME}/openclaw/workspace-main` elsewhere, with explicit environment-variable overrides.
...
- primary local machine: `/Users/shift/openclaw/workspace-xmanx`
...
- **可迁移工作区默认值**
  在主力本机默认指向 `/Users/shift/openclaw/workspace-xmanx`，其他环境默认使用 `${HOME}/openclaw/workspace-main`，并支持环境变量覆盖。
...
- 主力本机：`/Users/shift/openclaw/workspace-xmanx`
